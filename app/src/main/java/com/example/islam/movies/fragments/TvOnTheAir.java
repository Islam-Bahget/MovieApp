...
public class TvOnTheAir extends Fragment implements DataView, ReAdapter.OnMovieClickListener {
    ...
    private void loadNextPage() {
        presenter.getMovies(currentPage, "on_the_air", Const.TV);
    ...
    public void onMovieClicked(int position) {
        startActivity(new Intent(getContext(), TvDetails.class).
                putExtra("id", tvs.get(position).getId()));
